        ...
        return Theme(
          data: Theme.of(context).copyWith(
            colorScheme: const ColorScheme.light(
              primary: Color(0xFFE57373), // Red color theme
                  ...
                  children: [
                      ...
                      child: AbsorbPointer( // Mencegah keyboard muncul
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            prefixIcon: Icon(Icons.calendar_today, color: Colors.grey[600], size: displayWidth(context) * 0.05),
                            hintText: 'Pilih tanggal',
                            hintStyle: TextStyle(fontSize: displayWidth(context) * 0.035, color: Colors.grey[400]),
                            contentPadding: EdgeInsets.symmetric(vertical: displayHeight(context) * 0.015),
                    ...
                    Container(
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton<String>(
                          ...
                          icon: Icon(Icons.keyboard_arrow_down, color: Colors.black87, size: displayWidth(context) * 0.06),
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        icon: Icon(Icons.search, color: Colors.white, size: displayWidth(context) * 0.05),
                        label: Text(
                          'Cari Laporan',
                          style: TextStyle(
                        ...
                        style: ElevatedButton.styleFrom(
                          ...
                          padding: EdgeInsets.symmetric(vertical: displayHeight(context) * 0.018),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      CircleAvatar(
                                        ...
                                        child: Icon(Icons.person, color: Colors.grey[600], size: displayWidth(context) * 0.07),
                                      ),
                                      SizedBox(width: displayWidth(context) * 0.03),
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              children: [
                                                Icon(Icons.calendar_today, size: displayWidth(context) * 0.03, color: Colors.grey[600]),
